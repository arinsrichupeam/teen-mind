...
export const CardOrange = ({ data, total }: props) => {
  return (
    <Card className="xl:max-w-sm bg-orange-200 rounded-xl shadow-md px-3 w-full">
      <CardBody className="py-5 overflow-hidden">
        <div className="flex items-center gap-2.5 justify-start">
          ...
          {/* <div className="flex basis-1/3 gap-2.5 py-2 items-center justify-end">
            <UsersIcon className="size-8 text-orange-700" />
          </div> */}
        </div>
