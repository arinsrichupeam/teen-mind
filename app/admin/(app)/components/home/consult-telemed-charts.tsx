  ...
  const stats = {
    ...
    byResult: {
      green: {
        ...
        consult: questions.filter(
          (q) => q.result === "Green" && q.consult && q.consult !== ""
        ).length,
        telemed: questions.filter(
      ...
      greenLow: {
        ...
        consult: questions.filter(
          (q) => q.result === "Green-Low" && q.consult && q.consult !== ""
        ).length,
        telemed: questions.filter(
      ...
      yellow: {
        ...
        consult: questions.filter(
          (q) => q.result === "Yellow" && q.consult && q.consult !== ""
        ).length,
        telemed: questions.filter(
      ...
      orange: {
        ...
        consult: questions.filter(
          (q) => q.result === "Orange" && q.consult && q.consult !== ""
        ).length,
        telemed: questions.filter(
      ...
      red: {
        ...
        consult: questions.filter(
          (q) => q.result === "Red" && q.consult && q.consult !== ""
        ).length,
        telemed: questions.filter(
          ...
          <CardBody className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500">
                  {consultTotal > 0
                    ? ((stats.consult.pending / consultTotal) * 100).toFixed(1)
                    : 0}
                  %
                </p>
              </div>
          ...
          <CardBody className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500">
                  {telemedTotal > 0
                    ? ((stats.telemed.scheduled / telemedTotal) * 100).toFixed(
                        1
                      )
                    : 0}
                  %
