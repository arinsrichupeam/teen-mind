...
CREATE TABLE `EmergencyContact` (
    ...
    INDEX `Emergency_profileId_fkey`(`profileId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- CreateTable
CREATE TABLE `Questions_PHQA_Addon` (
    `id` VARCHAR(191) NOT NULL,
    `questions_MasterId` VARCHAR(191) NULL,
    `q1` INTEGER NOT NULL,
    `q2` INTEGER NOT NULL,

    INDEX `Questions_PHQA_Addon_questions_MasterId_idx`(`questions_MasterId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `Questions_PHQA_Addon` ADD CONSTRAINT `Questions_PHQA_Addon_questions_MasterId_fkey` FOREIGN KEY (`questions_MasterId`) REFERENCES `Questions_Master`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
